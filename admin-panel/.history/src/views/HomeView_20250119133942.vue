...
import { faDoopOpen } from "@fortawesome/free-solid-svg-icons";
    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
        ...
        <li>
          ...
          >
            <FontAwesomeIcon class="text-gray-600 text-2xl" :icon="faHouse" />
          ...
          <ul id="dropdown-example" class="hidden py-2 space-y-2">
            <li>
              ...
              >
                <i class="pi pi-plus pt-1"></i> Add new Room</a
              >
            </li>
          </ul>
        </li>
        <li>
          <button
            ...
            data-collapse-toggle="dropdown-example"
          >
            <FontAwesomeIcon class="text-gray-600 text-2xl" :icon="faUsers" />
