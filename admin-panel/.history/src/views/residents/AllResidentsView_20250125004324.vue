...
<template>
  <div class="card">
    ...
    >
      ...
      <Column field="firstname" header="Firstname" style="min-width: 12rem">
      ...
      <Column header="Lastname" filterField="lastname" style="min-width: 12rem">
        <template #body="{ data }">
          <div class="flex items-center gap-2">
            <img
              alt="flag"
              src="https://primefaces.org/cdn/primevue/images/flag/flag_placeholder.png"
              :class="`flag flag-${data.countryCode}`"
              style="width: 24px"
            />
