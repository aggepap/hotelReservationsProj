  ...
  >
    <div v-for="room in state.rooms" :key="room.roomNumber" :room="room">
      <div
        ...
        class="rounded-lg shadow-md py-6 h-[15rem] flex flex-col items-center justify-between"
      >
