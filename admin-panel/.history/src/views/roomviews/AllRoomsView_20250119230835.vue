...
<template>
  ...
  <section
    class="w-9/12 mx-auto px-10 h-full grid grid-cols-4 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10"
  >
  ...
  <section class="flex items-center justify-center">
    ...
    <select class="rounded-md justify-self-end" name="pagesize" id="pageSize">
