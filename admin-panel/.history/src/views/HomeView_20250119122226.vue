    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
        ...
        <li>
          ...
          >
            <!-- <i class="pi pi-home" style="font-size: 1.5rem; color: black"></i> -->
          ...
          <ul id="dropdown-example" class="hidden py-2 space-y-2">
            <li>
              <a
                href="#"
                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 flex justify-between"
              >
                <i class="pi pi-plus"></i> Add new Room</a
              >
            </li>
          </ul>
        </li>
